...
--  hi('Constant',     { fg = '#ffa0a0',                            ctermfg = 'Magenta' })
  hi('Constant',     { fg = '#ffaa44',                            ctermfg = 'Magenta' })
--  hi('Special',      { fg = 'Orange',                             ctermfg = 'LightRed' })
  hi('Special',      { fg = '#88eeff', bold = false,             ctermfg = 'LightRed' })
--  hi('Identifier',   { fg = '#40ffff',                            ctermfg = 'Cyan', cterm = { bold = true } })
  hi('Identifier',   { fg = '#c0c0c0',                            ctermfg = 'Cyan', cterm = { bold = true } })
  hi('Statement',    { fg = '#ffff60', bold = false,               ctermfg = 'Yellow' })
  hi('PreProc',      { fg = '#ff80ff',                            ctermfg = 'LightBlue' })
  hi('Type',         { fg = '#60ff60', bold = false,               ctermfg = 'LightGreen' })
